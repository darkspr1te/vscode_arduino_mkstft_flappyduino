...
//This is where the initial LCD magic happen
//darkspr1te

//FSMC not supported on our board
//#define FSMC_TFT
...
void UTFT::_hw_special_init(void)
{
 // STM_FSMC_LCD_Init();
  ...
  //We are using PWM now but in case you want the old way
...
//Read from LCD ,you can read settings , model /manufacturer , GRAM 
...
{  
  ...
  set_register(1);
  delay(10);
   //first clock is dummy so remember to throw that datat away, see HX8353 manual for more info
